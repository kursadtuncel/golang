...
func SlicesIndex[S ~[]E, E comparable](s S, v E) int {
	...
	return -1
	//As an example of a generic function, SlicesIndex takes a slice of any comparable type and an element of that type and returns
	//the index of the first occurrence of v in s, or -1 if not present. The comparable constraint means that we can compare values of this type with
	//the == and != operators.
}
...
func main() {
	...
	_ = SlicesIndex[[]string, string](s, "zoo") //… though we could also specify them explicitly.
